...
const Approach = () => {
  return (
    <section className="w-full py-20">
      ...
      <div className="flex flex-col items-center justify-center gap-8 px-4 py-20 lg:flex-row lg:gap-4 xl:px-0">
        <Card
        ...
        <Card title="Design & Prototyping" icon={<AceternityIcon order="Phase 2"/>}
          description="I turn the strategy into an intuitive visual experience with wireframes, prototypes, and a design system that reflects your brand.">
          <CanvasRevealEffect
            animationSpeed={3}
