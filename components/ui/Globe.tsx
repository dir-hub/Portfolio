...
import { Color, Fog, Group, Object3D, PerspectiveCamera, Scene, Vector3 } from "three";
...
export function Globe({ globeConfig, data }: WorldProps) {
  ...
  useEffect(() => {
    if (!globeRef.current && groupRef.current) {
      const node = new ThreeGlobe();
      globeRef.current = node;
      (groupRef.current as Group).add(node as unknown as Object3D);
